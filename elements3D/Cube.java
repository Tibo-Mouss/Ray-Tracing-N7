...
public class Cube implements Objet3D, Serializable {
	...
	public Cube(Point centre, double arete) throws NomVideException { // ne devrait jamais throw l'exception en r�alit�
	 ...
	 * 
	 * On deduit la face qui est en jeu. Et paf �a fait des chocapics
	 * 
	 * @param impact : Point d'impact du rayon qui appartient au plan
	 ...
	 * @param p : point o� a lieu la collision
	 */
	@Override
	 ...
	 * 				Si le point appartient � une arete/coin --> renvoie un plan au hasard
