...
public class FenetrePrincipale {
	...
	private void initialize() {
		...
		JMenuItem itemAjouterL = new JMenuItem("Ajouter Lumi�re");
	...
	public class ActionOuvrirLumiere extends MouseAdapter {
		public void mouseClicked(MouseEvent evt) {
	        if (evt.getClickCount() == 2) {
				//FenetreLumiere lux = new FenetreLumiere("Lumi�re", rayTracing,listeL,listLumieres);
				//lux.setVisible(true);
	...
	public class ActionEnregistrerS implements ActionListener {
		...
		public void actionPerformed(ActionEvent ev) {
			EnregistrerScene enregistrer = new EnregistrerScene( "Enregistrer Sc�ne", rayTracing);
			enregistrer.setVisible(true);
